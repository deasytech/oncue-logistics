<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Payment Instructions - Conditional based on payment method -->
            ...
            <div
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-yellow-700 dark:text-yellow-300 mb-4"><strong>Please make payment within 24 hours
                                to
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">Oncue Events &
                                        Logistics</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="font-bold text-green-600">₦{{ number_format($payment->amount, 2) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-pink-700 dark:text-pink-300 text-sm">
                                Please use your order reference <strong
                                    class="font-mono">{{ $payment->reference }}</strong>
                                as the payment description/remark.
                            </p>
                        </div>

                        <div class="space-y-2">
                            <p class="text-yellow-700 dark:text-yellow-300">After making payment, please send proof of
                                payment to:</p>
                            <div class="flex flex-wrap gap-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm">payments@oncuelogistics.com</span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                    ...
                                    <span class="text-sm">+234 803 456 7890</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        @else
            ...
            <div
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-green-800 dark:text-green-400 mb-3">Payment Confirmed!
                        </h3>
                        <p class="text-green-700 dark:text-green-300 mb-4"><strong>Your online payment has been
                                successfully processed.</strong></p>

                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Payment Details</h4>
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        {{ $payment->updated_at->format('F j, Y g:i A') }}
                                    </span>
                                </div>
                                <div class="flex justify-between">
                        ...
                        <div
                            ...
                            <h4 class="font-semibold text-blue-800 dark:text-blue-400 mb-2">📧 Email Confirmation</h4>
                            <p class="text-blue-700 dark:text-blue-300 text-sm">
                                A confirmation email has been sent to
                                <strong>{{ $payment->customer_info['email'] ?? $payment->customer->email }}</strong>
        ...
        <!-- Next Steps - Conditional based on payment method -->
        @if ($payment->payment_method === 'offline')
            <!-- Offline Payment Next Steps -->
            <div
                class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-6">
                ...
                <ol class="space-y-2 text-green-700 dark:text-green-300">
                    ...
                    <li class="flex items-start">
                        ...
                        <span>Send proof of payment to us</span>
                    </li>
                    <li class="flex items-start">
                        <span
            ...
            <div
                ...
                <ol class="space-y-2 text-green-700 dark:text-green-300">
                    <li class="flex items-start">
                        <span
                            class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5">1</span>
                        <span>Your payment has been confirmed and order is being processed</span>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5">2</span>
                        <span>We'll prepare your order according to your specifications</span>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5">3</span>
                        <span>You'll receive updates on order progress via email</span>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5">4</span>
                        <span>Your order will be ready for pickup/delivery as scheduled</span>
                    </li>
                    <li class="flex items-start">
                        <span
                            class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5">5</span>
